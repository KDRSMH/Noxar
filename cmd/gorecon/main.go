...
func showBanner() {
	...
	fmt.Println("============================================================")
	fmt.Println("                   " + ColorRed + "N" + ColorPurple + ColorBold + " O X " + ColorRed + "A" + ColorPurple + ColorBold + " R v1.0")
	fmt.Println("           " + ColorRed + "N" + ColorPurple + ColorBold + "etwork Reconnaissance Tool")
	fmt.Println("          " + ColorRed + "A" + ColorPurple + ColorBold + "dvanced Network Security Scanner")
	fmt.Println("============================================================")
